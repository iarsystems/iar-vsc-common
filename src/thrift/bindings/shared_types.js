...
export const CSpyException = class extends Thrift.TException {
  constructor(args) {
    super("CSpyException");
...
export const SourceLocation = class {
  constructor(args) {
    this.filename = null;
    this.line = null;
    this.col = null;
  ...
  ["write"] (output) {
    ...
    try {
      ...
      if (this.locations !== null && this.locations !== undefined) {
        ...
        for (let iter4 in this.locations) {
...
export const SourceRange = class {
  constructor(args) {
    this.filename = null;
    this.first = null;
    this.last = null;
...
export const ContextInfo = class {
  constructor(args) {
    this.context = null;
    this.aliases = null;
  ...
  ["write"] (output) {
    ...
    try {
      ...
      if (this.sourceRanges !== null && this.sourceRanges !== undefined) {
        ...
        for (let iter9 in this.sourceRanges) {
...
export const StackSettings = class {
  constructor(args) {
...
export const PropertyTreeItem = class {
  constructor(args) {
    this.key = null;
    this.value = null;
    this.children = null;
  ...
  ["write"] (output) {
    ...
    try {
      ...
      if (this.children !== null && this.children !== undefined) {
        ...
        for (let iter14 in this.children) {
...
export const Capabilities = class {
  constructor(args) {
...
export const DownloadConfiguration = class {
  constructor(args) {
  ...
  ["write"] (output) {
    ...
    try {
      ...
      if (this.deviceMacros !== null && this.deviceMacros !== undefined) {
        ...
        for (let iter23 in this.deviceMacros) {
      ...
      if (this.extraImages !== null && this.extraImages !== undefined) {
        ...
        for (let iter24 in this.extraImages) {
...
export const LaunchConfiguration = class {
  constructor(args) {
    this.program = null;
  ...
  ["write"] (output) {
    ...
    try {
      ...
      if (this.programArgs !== null && this.programArgs !== undefined) {
        ...
        for (let iter46 in this.programArgs) {
      ...
      if (this.driverOptions !== null && this.driverOptions !== undefined) {
        ...
        for (let iter47 in this.driverOptions) {
      ...
      if (this.setupMacros !== null && this.setupMacros !== undefined) {
        ...
        for (let iter48 in this.setupMacros) {
      ...
      if (this.macroParams !== null && this.macroParams !== undefined) {
        ...
        for (let kiter49 in this.macroParams) {
          if (this.macroParams.hasOwnProperty(kiter49)) {
            let viter50 = this.macroParams[kiter49];
      ...
      if (this.plugins !== null && this.plugins !== undefined) {
        ...
        for (let iter51 in this.plugins) {
