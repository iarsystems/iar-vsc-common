...
export const ToolbarNote = class {
  constructor(args) {
    this.what = null;
    this.focusOn = null;
    if (args) {
...
export const ToolbarItemState = class {
  constructor(args) {
    this.enabled = null;
    this.visible = null;
    this.on = null;
...
export const AddRowsResult = class {
  constructor(args) {
    this.chunkInfo = null;
    this.rows = null;
    if (args) {
...
export const NavigateResult = class {
  constructor(args) {
    this.chunkInfo = null;
    this.chunkPos = null;
    if (args) {
...
export const SelectionResult = class {
  constructor(args) {
    this.row = null;
    this.pos = null;
    if (args) {
...
export const StackBarInfo = class {
  constructor(args) {
...
export const TraceCustomParameter = class {
  constructor(args) {
    this.name = null;
    this.value = null;
    if (args) {
...
export const TraceFindParams = class {
  constructor(args) {
    this.findWhat = null;
    this.useRange = null;
  ...
  ["write"] (output) {
    ...
    try {
      ...
      if (this.columns !== null && this.columns !== undefined) {
        ...
        for (let iter22 in this.columns) {
      ...
      if (this.searchHistory !== null && this.searchHistory !== undefined) {
        ...
        for (let iter23 in this.searchHistory) {
      ...
      if (this.customParameters !== null && this.customParameters !== undefined) {
        ...
        for (let iter24 in this.customParameters) {
...
export const TraceProgress = class {
  constructor(args) {
    this.current = null;
    this.maxvalue = null;
    if (args) {
...
export const DragDropFeedback = class {
  constructor(args) {
    this.target = null;
    this.rowIdx = null;
    this.colIdx = null;
...
export const ListWindowRenderParameters = class {
  constructor(args) {
    this.listSpec = null;
    this.columns = null;
    this.rows = null;
  ...
  ["write"] (output) {
    ...
    try {
      ...
      if (this.columns !== null && this.columns !== undefined) {
        ...
        for (let iter37 in this.columns) {
      ...
      if (this.selection !== null && this.selection !== undefined) {
        ...
        for (let iter39 in this.selection) {
