    ...
    try {
      ...
      while (true) {
        ...
        switch (fid) {
          ...
          case 5:
          if (ftype == Thrift.Type.STRING) {
            this.projectRelativePath = input.readString();
          } else {
            input.skip(ftype);
          }
          break;
...
export const ComponentInfo = class {
  constructor(args) {
    ...
    try {
      ...
      while (true) {
        ...
        switch (fid) {
          case 1:
          if (ftype == Thrift.Type.STRING) {
            this.deviceClass = input.readString();
          } else {
            input.skip(ftype);
          }
          break;
          ...
          case 10:
          if (ftype == Thrift.Type.STRING) {
            this.rteComponentsH = input.readString();
          } else {
            input.skip(ftype);
          }
          break;
          case 11:
          if (ftype == Thrift.Type.I32) {
            this.selectedCount = input.readI32();
          } else {
            input.skip(ftype);
          }
          break;
  ...
  ["write"] (output) {
    ...
    try {
      ...
      if (this.sourceFiles !== null && this.sourceFiles !== undefined) {
        ...
        for (let iter4 in this.sourceFiles) {
...
export const CompileInfo = class {
  constructor(args) {
    this.Pname = null;
    this.header = null;
    this.define = null;
...
export const ProcessorInfo = class {
  constructor(args) {
    this.Pname = null;
    this.Dvendor = null;
    this.Dcore = null;
    ...
    try {
      ...
      while (true) {
        ...
        switch (fid) {
          ...
          case 8:
          if (ftype == Thrift.Type.STRING) {
            this.DcoreVersion = input.readString();
          } else {
            input.skip(ftype);
          }
          break;
    ...
    try {
      ...
      while (true) {
        ...
        switch (fid) {
          ...
          case 6:
          if (ftype == Thrift.Type.STRING) {
            this.subFamily = input.readString();
          } else {
            input.skip(ftype);
          }
          break;
  ...
  ["write"] (output) {
    ...
    try {
      ...
      if (this.compile !== null && this.compile !== undefined) {
        ...
        for (let iter13 in this.compile) {
      ...
      if (this.processor !== null && this.processor !== undefined) {
        ...
        for (let iter14 in this.processor) {
...
export const ValidationStatus = class {
  constructor(args) {
    this.id = null;
    this.result = null;
    this.fulfilled = null;
    ...
    try {
      ...
      while (true) {
        ...
        switch (fid) {
          case 1:
          if (ftype == Thrift.Type.STRING) {
            this.componentClass = input.readString();
          } else {
            input.skip(ftype);
          }
          break;
    ...
    try {
      ...
      while (true) {
        ...
        switch (fid) {
          ...
          case 3:
          if (ftype == Thrift.Type.STRING) {
            this.packPath = input.readString();
          } else {
            input.skip(ftype);
          }
          break;
          case 4:
          if (ftype == Thrift.Type.STRING) {
            this.packRelativePath = input.readString();
          } else {
            input.skip(ftype);
          }
          break;
...
export const CMSISAgentException = class extends Thrift.TException {
  constructor(args) {
    super("CMSISAgentException");
    this.name = "CMSISAgentException";
    this.message = null;
    if (args) {
...
export const CMSISPACK_AGENT2_SERVICE = 'com.iar.cmsisagent2.service';
export const CMSISPACK_AGENT2_EVENTLISTENER_SERVICE = 'com.iar.cmsisagent2.eventlistener.service';
export const PROJECT_ADDED = 'com.arm.cmsis.pack.rte.project.added';
export const PROJECT_REMOVED = 'com.arm.cmsis.pack.rte.project.removed';
export const PROJECT_UPDATED = 'com.arm.cmsis.pack.rte.project.updated';
export const PACKS_UPDATED = 'com.arm.cmsis.pack.updated';
export const PACKS_RELOADED = 'com.arm.cmsis.pack.reloaded';
