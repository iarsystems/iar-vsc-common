...
FrontendClient.prototype.send_getCapabilities = function() {
  var output = new this.pClass(this.output);
...
FrontendClient.prototype.recv_getCapabilities = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
...
FrontendProcessor.prototype.process_getCapabilities = function(seqid, input, output) {
  var args = new Frontend_getCapabilities_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.getCapabilities.length === 0) {
    Q.fcall(this._handler.getCapabilities.bind(this._handler)
    ).then(function(result) {
      var result_obj = new Frontend_getCapabilities_result({success: result});
    ...
    this._handler.getCapabilities(function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined')) {
