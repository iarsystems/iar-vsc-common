...
declare class Client extends ListWindowBackend.Client {
    ...
    setStack(name: string): Promise<void>;
...
declare class Processor extends ListWindowBackend.Processor {
  ...
  process(input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_setStack(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getStack(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getStacks(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getBarTooltip(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getBarInfo(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getStackSettings(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
}
