...
declare class Processor {
  ...
  process(input: thrift.TProtocol, output: thrift.TProtocol): void;
    ...
    process_GetSoftCTI(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_CoreStarting(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_CoreStopping(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
}
