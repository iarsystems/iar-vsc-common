...
declare class Processor extends HeartbeatService.Processor {
  ...
  process(input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_SyncTo(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_CurrentState(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_AllStates(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
}
