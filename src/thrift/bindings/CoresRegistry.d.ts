...
declare class Processor extends HeartbeatService.Processor {
  ...
  process(input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_NumberOfCores(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_AllCores(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_GetInfo(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_SetInfo(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_SetInfoPartial(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_PartnerCores(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_SetNumberOfCores(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_ResetAfterDebugSession(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
}
