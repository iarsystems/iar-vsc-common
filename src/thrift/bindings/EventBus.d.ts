...
declare class Client extends HeartbeatService.Client {
    ...
    Fire(toBeFired: Event): Promise<void>;

    Fire(toBeFired: Event, callback?: (error: void, response: void)=>void): void;

    RegisterWithVersion(clientLocation: ServiceRegistry_ttypes.ServiceLocation, myId: number, ampVersion: number): Promise<void>;
    ...
    Register(clientLocation: ServiceRegistry_ttypes.ServiceLocation, myId: number): Promise<void>;
