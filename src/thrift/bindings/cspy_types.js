...
export const DkCoreStatusConstants = {
...
export const DkLoggingCategoryConstant = {
  '0' : 'kDkLogUser',
  'kDkLogUser' : 0,
  '1' : 'kDkLogInfo',
  'kDkLogInfo' : 1,
...
export const SessionConfiguration = class {
  constructor(args) {
    this.type = null;
  ...
  ["write"] (output) {
    ...
    try {
      ...
      if (this.options !== null && this.options !== undefined) {
        ...
        for (let iter12 in this.options) {
      ...
      if (this.setupMacros !== null && this.setupMacros !== undefined) {
        ...
        for (let iter13 in this.setupMacros) {
      ...
      if (this.plugins !== null && this.plugins !== undefined) {
        ...
        for (let iter14 in this.plugins) {
...
export const InspectionContextChangedEvent = class {
  constructor(args) {
    this.context = null;
    if (args) {
...
export const BaseContextChangedEvent = class {
  constructor(args) {
    this.context = null;
    if (args) {
      if (args.context !== undefined && args.context !== null) {
...
export const NamedLocationMask = class {
  constructor(args) {
    this.used = null;
    this.shift = null;
    this.mask = null;
...
export const NamedLocation = class {
  constructor(args) {
    this.name = null;
    this.nameAlias = null;
    this.readonly = null;
...
export const ExtraDebugFile = class {
  constructor(args) {
...
export const ModuleLoadingOptions = class {
  constructor(args) {
  ...
  ["write"] (output) {
    ...
    try {
      ...
      if (this.extraDebugFiles !== null && this.extraDebugFiles !== undefined) {
        ...
        for (let iter29 in this.extraDebugFiles) {
...
export const ResetStyles = class {
  constructor(args) {
    this.name = null;
    this.id = null;
    this.selected = null;
...
export const DebugSettings = class {
  constructor(args) {
...
export const DEBUGGER_SERVICE = 'debugger';
export const DEBUGEVENT_SERVICE = 'debugger.eventhandler';
export const CONTEXT_MANAGER_SERVICE = 'debugger.contextmanager';
export const MEMORY_SERVICE = 'debugger.memory';
