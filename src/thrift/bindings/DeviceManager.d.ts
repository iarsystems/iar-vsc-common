...
declare class Client {
     ...
     */
    getRepositoriesForToolchain(toolchainId: string): Promise<Repository[]>;
     ...
     */
    getDevicesForRepository(repository: Repository): Promise<{ [k: string]: Device; }>;
     ...
     * @throws DeviceManagerError if the repository definition is invalid or cannot be registered
     */
    addRepositoryForLocalPath(localPath: string, toolchainId: string, displayName: string): Promise<Repository>;
     ...
     */
    removeRepositoryForUri(uri: string, toolchainId: string): Promise<void>;
     ...
     * 3
     */
    addRepositoriesFromToolchains(): Promise<{ [k: string]: Repository[]; }>;
