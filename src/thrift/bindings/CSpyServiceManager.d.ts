...
declare class Client {
     ...
     * being thrown.
     */
    startService(serviceConfig: ServiceConfig): Promise<void>;
     ...
     * being thrown.
     */
    stopService(serviceConfig: ServiceConfig): Promise<void>;
     ...
     *    being thrown.
     */
    startServicesFromJsonManifest(jsonFilePath: string): Promise<void>;
     ...
     * being thrown.
     */
    stopServicesFromJsonManifest(jsonFilePath: string): Promise<void>;
