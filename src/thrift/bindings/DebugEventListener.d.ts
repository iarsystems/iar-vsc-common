...
declare class Client {
     ...
     */
    postDebugEvent(event: DebugEvent): Promise<void>;
     ...
     */
    postLogEvent(event: LogEvent): Promise<void>;
     ...
     */
    postInspectionContextChangedEvent(event: InspectionContextChangedEvent): Promise<void>;
     ...
     */
    postBaseContextChangedEvent(event: BaseContextChangedEvent): Promise<void>;
