...
declare class Client extends ListWindowBackend.Client {
    ...
    add(expr: string): Promise<void>;

    add(expr: string, callback?: (error: void, response: void)=>void): void;
  }

declare class Processor extends ListWindowBackend.Processor {
  constructor(handler: object);
  process(input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_add(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
}
