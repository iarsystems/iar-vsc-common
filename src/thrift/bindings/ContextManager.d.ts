...
declare class Client extends HeartbeatService.Client {
     ...
     */
    setInspectionContext(context: shared_ttypes.ContextRef): Promise<void>;
     ...
     */
    findContext(context: shared_ttypes.ContextRef): Promise<shared_ttypes.ContextRef>;
     ...
     */
    getStack(context: shared_ttypes.ContextRef, low: number, high: number): Promise<shared_ttypes.ContextInfo[]>;
    ...
    getStackDepth(context: shared_ttypes.ContextRef, maxDepth: number): Promise<number>;
     ...
     */
    getContextInfo(context: shared_ttypes.ContextRef): Promise<shared_ttypes.ContextInfo>;
     ...
     */
    compareContexts(ctx1: shared_ttypes.ContextRef, ctx2: shared_ttypes.ContextRef): Promise<boolean>;
