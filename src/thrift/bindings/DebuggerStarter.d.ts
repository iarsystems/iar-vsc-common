...
declare class Client extends HeartbeatService.Client {
    ...
    Configure(stageDir: string, defaultTool: Tools): Promise<void>;

    Configure(stageDir: string, defaultTool: Tools, callback?: (error: void, response: void)=>void): void;

    StartServiceRegistry(): Promise<ServiceRegistry_ttypes.ServiceLocation>;

    StartServiceRegistry(callback?: (error: void, response: ServiceRegistry_ttypes.ServiceLocation)=>void): void;

    StartDebuggers(parentServiceRegistryLoc: ServiceRegistry_ttypes.ServiceLocation, sharedServiceRegistryLoc: ServiceRegistry_ttypes.ServiceLocation): Promise<ServiceRegistry_ttypes.ServiceLocation[]>;
    ...
    TerminateDebuggers(): Promise<void>;

    TerminateDebuggers(callback?: (error: ServiceRegistry_ttypes.ServiceException, response: void)=>void): void;

    GetPartnerNamespace(partnerId: number, sharedServiceRegistryLoc: ServiceRegistry_ttypes.ServiceLocation): Promise<string>;
...
declare class Processor extends HeartbeatService.Processor {
  ...
  process(input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_Configure(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_StartServiceRegistry(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_StartDebuggers(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_TerminateDebuggers(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_GetPartnerNamespace(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
}
