 ...
 */
declare class DebuggerPlugin {
    public name: string;
    public description: string;
    public path: string;
    public originator: string;
    public version: string;
    public currentLoad: boolean;
    public factoryLoad: boolean;
    public keywordRoot: string;

      read(input: object): void;
  write(output: object): void;
  constructor(args?: { name: string; description: string; path: string; originator: string; version: string; currentLoad: boolean; factoryLoad: boolean; keywordRoot: string; });
  }
...
declare class OptionElementDescription {
    ...
    public elements: OptionElementDescription[];
      ...
      read(input: object): void;
  write(output: object): void;
  constructor(args?: { id: string; label: string; enabled: boolean; data: string; description: string; elements: OptionElementDescription[]; });
  }
...
declare class OptionDescription {
    ...
    public description: string;
      ...
      read(input: object): void;
  write(output: object): void;
  constructor(args?: { id: string; value: string; type: OptionType; elements: OptionElementDescription[]; enabled: boolean; visible: boolean; canBeLocal: boolean; inherited: boolean; description: string; });
  }
...
declare const PROJECTMANAGER_ID: string;
