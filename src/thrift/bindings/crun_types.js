...
export const CRunMessage = class {
  constructor(args) {
    this.id = null;
    this.index = null;
    this.core = null;
  ...
  ["write"] (output) {
    ...
    try {
      ...
      if (this.subMessages !== null && this.subMessages !== undefined) {
        ...
        for (let iter12 in this.subMessages) {
      ...
      if (this.callStack !== null && this.callStack !== undefined) {
        ...
        for (let iter13 in this.callStack) {
      ...
      if (this.extraSourceRanges !== null && this.extraSourceRanges !== undefined) {
        ...
        for (let iter14 in this.extraSourceRanges) {
...
export const CRUN_DISPLAY_SERVICE = 'crun.display';
export const CRUN_BACKEND_SERVICE = 'crun.backend';
