...
export namespace WorkbenchFeatures {
    ...
    */
    ...
    /**
     * Whether this workbench supports the ExpandArgVars thrift procedure.
     */
    export const ExpandArgVars: FeatureRequirement =
    { baseVersion: [9,1,1], minProductType: WorkbenchType.EXTENDED_BX };
